...
def knowledge_base():
    ...
    knowledge_base_dict = {"dnd": "Go to dndbeyond",
                           "rules": "Find more in the player's handbook and at D&D beyond",
                           "witchlight": "cast spells of explosive fire, arcing lightning, subtle deception, and brute-force mind control.",
                           "dungeons": "share an unparalleled mastery with weapons and armor, and a thorough knowledge of the skills of combat.",
                           "character": "create a character in minutes and jump into action with your digital character sheet. ",
                           "games": "gaming table primarily intended for pen-and-paper style narrative roleplaying games",
                           "d&d": "You can play D&D solo or with one friend (a duet) to satisfy that urge to roll your d20s",
                           "dm": "tell fantastic stories with your friends ",
                           "story": "Even if the group doesn’t complete the adventure successfully, the good time and memories make everyone a winne",
                           "adventurers": " create an exciting story where their bold adventurers confront deadly perils."}
